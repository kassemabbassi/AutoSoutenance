 ...
 * @author Wind10
 */
public class Affichageetudiant extends javax.swing.JFrame {


    public Affichageetudiant() {
        initComponents();
        initMoving(Affichageetudiant.this);
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Prénom", "Nom", "Cin", "Email", "Téléphone", "CinEncadreur", "Date"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Affichageetudiant.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Affichageetudiant().setVisible(true);
            }
        });
    }
