...
public class MenuBorderEtudiant extends javax.swing.JPanel {

    public MenuBorderEtudiant() {
        initComponents();
        setOpaque(false);

        // Configuration des boutons
        customizeButton(btn1, "Ajouter étudiant");
        customizeButton(btn2, "Supprimer étudiant");
        customizeButton(btn3, "Rechercher");
        customizeButton(btn4, "Modifier");
    ...
    private void initComponents() {
        ...
        iconlabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Etudiant/iconetudiant.png")));
